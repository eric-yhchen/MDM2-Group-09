...
def metronome_matrix_system(t, y, control_mode):
...
def solver(control_mode):
    t_span = (0, T_max)
    y0 = [theta1_0_init, omega1_0, theta2_0_init, omega2_0, x_0, v_0]
    t_eval = np.arange(0, T_max, dt)

    sol = solve_ivp(metronome_matrix_system, t_span, y0, args=[control_mode], t_eval=t_eval, method="RK45")
